...
class ChessPieceDetector:
    ...
    def extract_hog_features(self, images, labels):
    ...
    def save_hog_features_to_excel(self, hog_features, hog_labels, file_path='hog_features.xlsx'):
        df = pd.DataFrame(hog_features)
        df['label'] = hog_labels
        df.to_excel(file_path, index=False)
        print(f"HOG features saved to {file_path}")
